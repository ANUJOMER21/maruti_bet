 ...
 * Use the [WinDataFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class WinDataFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_win_data, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment WinDataFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            WinDataFragment().apply {
