 ...
 * Use the [withdrawHistfragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class withdrawHistfragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_withdraw_histfragment, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment withdrawHistfragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            withdrawHistfragment().apply {
