 ...
 * Use the [JodiDigitV2.newInstance] factory method to
 * create an instance of this fragment.
 */
class JodiDigitV2 : Fragment() ,BetItemListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(ViewModelJodiDigit::class.java)
...
/*    private lateinit var openRadioButton: RadioButton
   ...
   private var closetimw:String=""
    ...
    private lateinit var viewModel: ViewModelJodiDigit
    ...
    override fun onCreateView(
        ...
        view= inflater.inflate(R.layout.fragment_jodi_digit_v2, container, false)
        ...
        viewModel.fromtopair.observe(viewLifecycleOwner, Observer {
            ...
            val to= pair.second
            val from=pair.first
            Log.d("fromvalue_fr","${from.toChar()} || $to")
            val betList:ArrayList<BetItem> =ArrayList()

            for ( i in 0..list!!.size-1){
                val f=list[i]
                val num=f.number.get(0).digitToInt()
                Log.d("fromvalue_fr","${from.toChar()} || $to")
 ...
 /*       if(sessionType.equals("close")){
    ...
    companion object {
         ...
         * @return A new instance of fragment JodiDigitV2.
         */
