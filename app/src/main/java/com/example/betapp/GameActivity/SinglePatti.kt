...
class SinglePatti : AppCompatActivity() {
            ...
            object : ApiResponse {
                override fun onSuccess(jsonObject: JsonObject) {
                    if(!jsonObject.isJsonNull){
                        ...
                        {Toast.makeText(this@SinglePatti,"Bet submitted",Toast.LENGTH_SHORT).show()
                            list.clear()
                            ...
                            Toast.makeText(this@SinglePatti,jsonObject.get("message").toString(),Toast.LENGTH_SHORT).show()
                        }
                    }
                    else{
                        Toast.makeText(this@SinglePatti,"Failed",Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onFailure(failure: String) {
                    Toast.makeText(this@SinglePatti,failure,Toast.LENGTH_SHORT).show()
                }
    ...
    private fun setdigits() {
        ...
        val list=gameData.SingleList().sorted()
