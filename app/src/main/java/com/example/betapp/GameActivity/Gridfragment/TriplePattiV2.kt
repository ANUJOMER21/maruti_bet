 ...
 * Use the [TriplePatti.newInstance] factory method to
 * create an instance of this fragment.
 */
class TriplePattiV2 : Fragment(),BetItemListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(ViewmodelTriplepatti::class.java)
    ...
    private lateinit var viewModel: ViewmodelTriplepatti
    ...
    override fun onCreateView(
        ...
        view=inflater.inflate(R.layout.fragment_triple_patti, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment TriplePatti.
         */
